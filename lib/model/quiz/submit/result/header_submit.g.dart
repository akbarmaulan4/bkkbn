...
HeaderSubmit _$fromJson(Map<String, dynamic> json) {
  return HeaderSubmit()
    ..kuis_id = json['kuis_id'] != null ? json['kuis_id'] is num ? (json['kuis_id'] as num).toInt() : int.tryParse(json['kuis_id'] as String) : -1
    ..result_id = json['result_id'] != null ? json['result_id'] is num ? (json['result_id'] as num).toInt() : int.tryParse(json['result_id'] as String) : -1
