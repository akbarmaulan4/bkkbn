...
Pertanyaan _$fromJson(Map<String, dynamic> json) {
  return Pertanyaan()
    ...
    ..pertanyaan_id = json['pertanyaan_id'] != null ? json['pertanyaan_id'] is num ? (json['pertanyaan_id'] as num).toInt() : int.tryParse(json['pertanyaan_id'] as String) : -1
    ...
    ..element =  json['element'] != null ? (json['element'] as List)
        .map((e) =>
    e == null ? null : ListAnswer.fromJson(e as Map<String, dynamic>)).cast<ListAnswer>()
        .toList():[]
  ;
}
