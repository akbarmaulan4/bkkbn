...
// import 'package:ec/helper/color_code.dart';
// import 'package:ec/helper/color_constant.dart';
// import 'package:ec/helper/constant.dart';
// import 'package:ec/helper/ec_helper.dart';
// import 'package:ec/helper/ec_size.dart';
...
//    final appBar = AppBar(automaticallyImplyLeading: false, title: AppBarPlacesAutoCompleteTextField());
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            ...
            // hintStyle: kBodyNormalText.copyWith(fontSize: 12, color: Color(0xFFACB3BA)),
            filled: true,
...
class PlacesAutocomplete {
  static Future<Prediction> show(
    ...
    return Navigator.push(context, CupertinoPageRoute(builder: builder));
  }
}
